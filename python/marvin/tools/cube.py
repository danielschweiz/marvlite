...
class Cube(MarvinToolsClass, NSAMixIn, GetApertureMixIn):
    ...
    def __init__(self, input=None, filename=None, 
                 #mangaid=None, plateifu=None, mode=None, 
                 data=None, 
                 #release=None, drpall=None, download=None, nsa_source='auto'
                ):
        ...
        MarvinToolsClass.__init__(self, input=input, filename=filename, 
                                  #mangaid=mangaid, plateifu=plateifu, mode=mode, 
                                  data=data, 
                                  #release=release, drpall=drpall, download=download
                                 )

        NSAMixIn.__init__(self, 
                          #nsa_source=nsa_source
                         )
